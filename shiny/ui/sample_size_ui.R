  ...
  fluidRow(
    column(12,
      div(style = "margin-bottom: 20px;",
        span(icon("calculator"), " Sample Size Estimation", 
             style = "font-weight: bold; font-size: 18px; color: #3498db;"),
        span(" — Powered by PowerTOST", 
             style = "margin-left: 8px; font-size: 13px; color: #6c757d;")
      )
    )
  ),
