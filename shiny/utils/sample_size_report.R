...
generate_sample_size_report <- function(ss_res, output_file) {
  ...
  params_block <- paste0(
    ...
    sprintf("<tr><td>Assumed T/R Ratio (θ₀)</td><td>%.4f</td></tr>", ss_res$theta0),
  ...
  body <- paste0(
    ...
    "<h2 class='sas-section'>2. Result</h2>", result_block,
    if (nzchar(console_block)) paste0(
      "<h2 class='sas-section'>3. PowerTOST Console Output</h2>", console_block) else "",
    "<hr class='sas-rule'>",
    ...
    "as reported by PowerTOST for the selected design.</p>"
  )
